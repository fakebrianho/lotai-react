...
export default function ProjectLayout({ children }) {
	console.log('video [id] layout rendering') // Add this line

	return (
		<div
			className={`${inter.className} ${textFont.variable} ${subFont.variable} ${monsterFont.variable} ${scriptFont.variable}`}
		>
